...
print('{:5>} \t {:10} {:<6} {:>8} {:>6}'.format("Octal", "Decimal", "Hex", "Bin", "Char"))
print('{0:-^42}'.format("-"))
for num in range(63,74):
    print('{0:>#5o} {0:10d} {0:^10x} {0:>7b} {0:6c}'.format(num))
...
# Keep it in 1 line
ip = "192.168.0.1"
from functools import reduce; print ('{}'.format(reduce(lambda a,b: a<<8 | b, map(int, ip.split(".")))))
